// help-system.module.js - Cleaned Version
(function () {
  "use strict";
  ...
  angular
    ...
    .service("HelpSystemService", [
      ...
      function ($http, $q, $window) {
        ...
        service.hasPermission = function (permission) {
          var userPermissions = $window.ERPUser
            ? $window.ERPUser.permissions
            : [];
    ...
    .directive("helpSidebar", [
      "HelpSystemService",
      "ThemeAdapterService",
      function (HelpSystemService, ThemeAdapterService) {
        return {
          restrict: "E",
          scope: {
            pageId: "@",
          ...
          template: `
            ...
            <div class="help-sidebar" ng-class="{'help-sidebar-open': isOpen}">
              ...
              <div class="help-content" ng-if="helpContent">
                ...
                <div class="help-sections">
                  <div class="help-section" ng-repeat="section in helpContent.sections">
                    ...
                    <div class="help-section-content" ng-show="expandedSections[section.id]">
                      ...
                      <!-- Stepper for Steps -->
                      <div class="help-stepper" ng-if="section.steps && section.steps.length > 0">
                        <h4 class="help-stepper-title">Steps:</h4>
                        <div class="stepper-container">
                          <div class="stepper-item" ng-repeat="step in section.steps" ng-class="{'stepper-item-last': $last}">
                            <div class="stepper-connector" ng-if="!$last"></div>
                      ...
                      <!-- Navigation Links -->
                      <div class="help-nav-links" ng-if="section.navigationLinks && section.navigationLinks.length > 0">
                        <h4>Quick Actions:</h4>
                ...
                <!-- FAQ Section -->
                <div class="help-faq" ng-if="helpContent.FrequentlyAskedQuestions && helpContent.FrequentlyAskedQuestions.length > 0">
                  <h3>Frequently Asked Questions</h3>
                  <ul class="help-faq-list">
                    <li ng-repeat="item in helpContent.FrequentlyAskedQuestions">{{item}}</li>
                  </ul>
                </div>
              </div>
          ...
          link: function (scope, element, attrs) {
            ...
            function loadHelpContent() {
              HelpSystemService.loadContent(scope.pageId).then(function (
                content
              ) {
                if (content) {
                  ...
                  scope.helpContent.sections.forEach(function (section) {
                    if (section.navigationLinks) {
                      section.navigationLinks =
                        HelpSystemService.filterNavigationLinks(
                          section.navigationLinks
                        );
                    }
                  });
            ...
            scope.toggleSection = function (sectionId) {
              scope.expandedSections[sectionId] =
                !scope.expandedSections[sectionId];
              HelpSystemService.trackHelpUsage(
                scope.pageId,
                "toggle_section",
                sectionId
              );
    ...
    .controller("HelpSystemController", [
      "$scope",
      "HelpSystemService",
      function ($scope, HelpSystemService) {
        var vm = this;
